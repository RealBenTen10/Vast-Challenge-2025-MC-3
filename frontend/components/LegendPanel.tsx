          ...
          <div className="flex flex-wrap gap-8" style={{ marginTop: 0, paddingTop: 0 }}>
            <div className="border rounded-lg p-4" style={{ marginTop: 0, paddingTop: 0 }}>
              ...
              <ul className="text-sm space-y-1">
                ...
                <li><span className="inline-block w-4 h-4 mr-2 rounded-full" style={{ backgroundColor: "#bcbd22 " }}></span>Monitoring</li>
                ...
                <li><span className="inline-block w-4 h-4 mr-2 rounded-full" style={{ backgroundColor: "#17becf" }}></span>HarborReport</li>
            ...
            <div className="border rounded-lg p-4" style={{ marginTop: 0, paddingTop: 0 }}>
              ...
              <div>
                ...
                <ul className="text-sm space-y-1">
                  ...
                  <li><span className="inline-block w-4 h-1 mr-2 align-middle" style={{ backgroundColor: "#000" }}></span>Communication</li>
